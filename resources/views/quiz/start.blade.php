			...
			<div class="col-md-4 offset-md-2">
				<div class="card m-3" >
					...
					<div class="card-body text-center">
						...
						<form action="{{ route('quizmensen.store') }}" method="post" accept-charset="utf-8">
							@csrf
						    <!-- Hidden quizmensen Type Form Input -->
						    <input type="hidden" id="quizmensen" name="quizmensen" value="1">
				...
				<div class="card m-3" >
					...
					<div class="card-body text-center">
						...
						<form action="{{ route('quizmensen.store') }}" method="post" accept-charset="utf-8">
							@csrf
						    <!-- Hidden quizmensen Type Form Input -->
						    <input type="hidden" id="quizmensen" name="quizmensen" value="2">
				...
				<div class="card m-3" >
					...
					<div class="card-body text-center">
						...
						<form action="{{ route('quizmensen.store') }}" method="post" accept-charset="utf-8">
							@csrf
						    <!-- Hidden quizmensen Type Form Input -->
						    <input type="hidden" id="quizmensen" name="quizmensen" value="3">
				...
				<div class="card m-3" >
					...
					<div class="card-body text-center">
						...
						<form action="{{ route('quizmensen.store') }}" method="post" accept-charset="utf-8">
							@csrf
						    <!-- Hidden quizmensen Type Form Input -->
						    <input type="hidden" id="quizmensen" name="quizmensen" value="4">
